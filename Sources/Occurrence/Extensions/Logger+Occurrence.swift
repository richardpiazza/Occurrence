...
public extension Logger {
    ...
    func trace(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
...
public extension Logger {
    ...
    func debug(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
...
public extension Logger {
    ...
    func info(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
...
public extension Logger {
    ...
    func notice(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
...
public extension Logger {
    ...
    func warning(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
...
public extension Logger {
    ...
    func error(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
...
public extension Logger {
    ...
    func critical(_ message: @autoclosure () -> Logger.Message, encodable: some Encodable, redacting keys: [String] = [], source: @autoclosure () -> String? = nil, file: String = #file, function: String = #function, line: UInt = #line) {
